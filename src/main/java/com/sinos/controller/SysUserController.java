package com.sinos.controller;

import com.sinos.config.redis.RedisService;
import com.sinos.entity.Permission;
import com.sinos.entity.User;
import com.sinos.entity.UserInfo;
import com.sinos.utils.JwtUtils;
import com.sinos.utils.MenuTree;
import com.sinos.utils.Result;
import com.sinos.vo.RouterVo;
import com.sinos.vo.TokenVo;
...
public class SysUserController {
    ...
    public Result getMenuList() {
        ...
        List<Permission> collect = permissionList.stream()
                .filter(item -> item != null && item.getType() != 2) //不筛选按钮 0，1，2-目录，菜单，按钮
